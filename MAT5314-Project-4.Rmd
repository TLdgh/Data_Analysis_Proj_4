...
```{r, echo=FALSE,fig.align='center', fig.cap = "The Number of Flight", out.height="3in", out.width="5in"}
...
```{r, echo=FALSE,fig.align='center', fig.cap = "The Distribution of Delay", out.height="3in", out.width="5in"}
